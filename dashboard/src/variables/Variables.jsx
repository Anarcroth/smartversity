...
var legendPie = {
    names: ["Persuasion","Finite","Calculus"],
    types: ["info","danger","warning"]
};

// Data for Line Chart
var dataSales = {
  labels: ['03/25','03/26','03/27','03/28','03/29','03/30', '03/31', ],
    series: [
        [2.00, 3.85, 3.90, 3.92, 3.54, 3.86, 3.98, 3.95],
        [2.67, 3.52, 2.43, 2.40, 2.87, 3.35, 3.35, 3.37],
        [2.23, 2.13, 2.67, 2.08, 2.90, 2.39, 3.07, 3.08]
    ]
};
var optionsSales = {
  low: 0,
...
var legendSales = {
    names: ["Calculus","Finite","Persuasion"],
    types: ["info","danger","warning"]
};
